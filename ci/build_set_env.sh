...
export IMAGE_NAME=$(mvn -q -Dexec.executable="echo" -Dexec.args='${project.artifactId}' --non-recursive exec:exec); echo $IMAGE_NAME
...
export IMAGE_PORT="12000"; echo $IMAGE_PORT;
