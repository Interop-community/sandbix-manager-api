...
export AWS_CONTAINER_PORT=12000
...
export IMAGE_COORDINATES="hspconsortium/hspc-sandbox-manager-api:0.6.4-SNAPSHOT"
export IMAGE_COORDINATES_ESCAPED="hspconsortium\/hspc-sandbox-manager-api:0\.6\.4-SNAPSHOT"
