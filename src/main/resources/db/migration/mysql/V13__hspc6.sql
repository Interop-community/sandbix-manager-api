...
VALUES
  ('', '2017-03-15 16:46:06', 'HSPC Development Sandbox 6', 'HSPC Sandbox 6', 'hspc6', '6', 1, null, 1);

INSERT INTO user_sandbox (user_id, sandbox_id)
VALUES
  (1, (SELECT id FROM sandbox WHERE sandbox_id='hspc6')),
  (1, (SELECT id FROM sandbox WHERE sandbox_id='hspc6'));
...
VALUES
  ((SELECT id FROM sandbox WHERE sandbox_id='hspc6'), (SELECT (MAX(id) - 2) FROM user_role)),
  ((SELECT id FROM sandbox WHERE sandbox_id='hspc6'), (SELECT (MAX(id) - 1) FROM user_role)),
  ((SELECT id FROM sandbox WHERE sandbox_id='hspc6'), (SELECT MAX(id) FROM user_role));
